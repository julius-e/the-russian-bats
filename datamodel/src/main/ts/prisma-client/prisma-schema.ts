export const typeDefs = /* GraphQL */ `type AggregateBatting {
  count: Int!
}
...
input BattingCreateInput {
  ...
  SF: Int
  GIDP: Int
  person: PersonCreateOneWithoutBattingInput!
}

input BattingCreateManyWithoutPersonInput {
  create: [BattingCreateWithoutPersonInput!]
}

input BattingCreateWithoutPersonInput {
  playerID: ID!
  yearID: Int
  stint: Int
  teamID: String
...
input BattingUpdateManyWithoutPersonInput {
  create: [BattingCreateWithoutPersonInput!]
...
type Mutation {
  ...
  updateManyBattings(data: BattingUpdateManyMutationInput!, where: BattingWhereInput): BatchPayload!
  ...
  updateManyPitchings(data: PitchingUpdateManyMutationInput!, where: PitchingWhereInput): BatchPayload!
...
type Person {
  ...
  retroID: String
  bbrefID: String
  batting(where: BattingWhereInput, orderBy: BattingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Batting!]
  pitching(where: PitchingWhereInput, orderBy: PitchingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Pitching!]
}
...
input PersonCreateInput {
  ...
  retroID: String
  bbrefID: String
  batting: BattingCreateManyWithoutPersonInput
  pitching: PitchingCreateManyWithoutPersonInput
}

input PersonCreateOneWithoutBattingInput {
  create: PersonCreateWithoutBattingInput
  connect: PersonWhereUniqueInput
}

input PersonCreateOneWithoutPitchingInput {
  create: PersonCreateWithoutPitchingInput
  connect: PersonWhereUniqueInput
}

input PersonCreateWithoutBattingInput {
  playerID: ID!
  birthYear: Int
  birthMonth: Int
  birthDay: Int
...
input PersonCreateWithoutPitchingInput {
  playerID: ID!
  birthYear: Int
  birthMonth: Int
  birthDay: Int
...
input PersonUpdateInput {
  ...
  retroID: String
  bbrefID: String
  batting: BattingUpdateManyWithoutPersonInput
  pitching: PitchingUpdateManyWithoutPersonInput
}
...
input PitchingCreateInput {
  ...
  SF: Int
  GIDP: Int
  person: PersonCreateOneWithoutPitchingInput!
}

input PitchingCreateManyWithoutPersonInput {
  create: [PitchingCreateWithoutPersonInput!]
}

input PitchingCreateWithoutPersonInput {
  playerID: ID!
  yearID: Int
  stint: Int
  teamID: String
...
input PitchingUpdateManyWithoutPersonInput {
  create: [PitchingCreateWithoutPersonInput!]
...
type Query {
  battings(where: BattingWhereInput, orderBy: BattingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Batting]!
  battingsConnection(where: BattingWhereInput, orderBy: BattingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): BattingConnection!
  person(where: PersonWhereUniqueInput!): Person
  persons(where: PersonWhereInput, orderBy: PersonOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Person]!
  personsConnection(where: PersonWhereInput, orderBy: PersonOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PersonConnection!
  pitchings(where: PitchingWhereInput, orderBy: PitchingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Pitching]!
  pitchingsConnection(where: PitchingWhereInput, orderBy: PitchingOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PitchingConnection!
  node(id: ID!): Node
}
